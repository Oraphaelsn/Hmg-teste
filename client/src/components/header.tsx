      ...
      <nav className="container mx-auto px-4 lg:px-8 relative z-10">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center space-x-3 group cursor-pointer">
            <div className="relative w-12 h-12 bg-gradient-to-r from-[#2c744c] via-emerald-600 to-[#1e5233] rounded-xl flex items-center justify-center shadow-2xl shadow-emerald-900/60 group-hover:shadow-emerald-400/80 transition-all duration-500 group-hover:scale-110 border-2 border-white/50 group-hover:border-emerald-300/80">
              {/* Multiple layered backgrounds for depth */}
              <div className="absolute inset-0 bg-gradient-to-r from-white/15 via-emerald-200/20 to-transparent rounded-xl animate-pulse"></div>
              <div className="absolute inset-0 bg-gradient-to-br from-emerald-300/20 to-transparent rounded-xl"></div>
              
              {/* Enhanced shine effect with multiple layers */}
              <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/30 to-transparent transform -skew-x-12 -translate-x-full group-hover:translate-x-full transition-transform duration-1000 rounded-xl"></div>
              <div className="absolute inset-0 bg-gradient-to-r from-transparent via-emerald-200/40 to-transparent transform skew-x-12 translate-x-full group-hover:-translate-x-full transition-transform duration-1200 rounded-xl"></div>
              
              {/* Outer glow effect */}
              <div className="absolute inset-0 rounded-xl bg-gradient-to-r from-emerald-400/30 to-white/30 blur-lg opacity-0 group-hover:opacity-100 transition-opacity duration-500 scale-110"></div>
              
              {/* Inner border glow */}
              <div className="absolute inset-1 rounded-xl border border-white/30 group-hover:border-emerald-200/60 transition-colors duration-500"></div>
              
              <Heart className="text-white relative z-10 drop-shadow-lg" size={22} />
            </div>
            <div className="flex flex-col relative">
              {/* Text container with corporate styling */}
              <div className="relative bg-gradient-to-r from-white/10 to-transparent px-3 py-1 rounded-lg border border-white/20 group-hover:border-emerald-300/50 transition-all duration-500 group-hover:bg-gradient-to-r group-hover:from-emerald-600/20 group-hover:to-transparent">
                {/* Multiple layered backgrounds for depth */}
                <div className="absolute inset-0 bg-gradient-to-r from-white/10 via-emerald-200/10 to-transparent rounded-lg animate-pulse"></div>
                <div className="absolute inset-0 bg-gradient-to-br from-emerald-300/10 to-transparent rounded-lg"></div>
                
                {/* Enhanced shine effect */}
                <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/20 to-transparent transform -skew-x-12 -translate-x-full group-hover:translate-x-full transition-transform duration-1000 rounded-lg"></div>
                <div className="absolute inset-0 bg-gradient-to-r from-transparent via-emerald-200/30 to-transparent transform skew-x-12 translate-x-full group-hover:-translate-x-full transition-transform duration-1200 rounded-lg"></div>
                
                {/* Outer glow effect */}
                <div className="absolute inset-0 rounded-lg bg-gradient-to-r from-emerald-400/20 to-white/20 blur-md opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
          ...
          <div className="hidden md:flex items-center space-x-2">
            ...
            <button 
              ...
              className="relative px-4 py-2 ml-4 bg-gradient-to-r from-[#2c744c] via-emerald-600 to-[#1e5233] hover:from-[#1e5233] hover:via-emerald-500 hover:to-[#2c744c] text-white font-black rounded-full transform hover:scale-110 transition-all duration-500 shadow-2xl shadow-emerald-900/60 hover:shadow-emerald-400/80 group overflow-hidden border-2 border-white/50 hover:border-emerald-300/80"
            >
              {/* Multiple layered backgrounds for depth */}
              ...
              <div className="relative flex items-center justify-center z-10">
                ...
                <div className="bg-white/30 p-1 rounded-full mr-2 group-hover:bg-white/40 transition-colors duration-300 group-hover:hidden shadow-lg border border-white/20">
                  <MessageCircle className="text-white drop-shadow-lg" size={16} />
                </div>
                
                {/* WhatsApp icon - appears on hover with original colors */}
                <div className="bg-[#25D366] p-1 rounded-full mr-2 group-hover:bg-[#128C7E] transition-all duration-300 hidden group-hover:block animate-bounce shadow-xl border-2 border-white/40">
